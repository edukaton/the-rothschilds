...
export default (entry => ({
  resolve: {
    ...
    alias: {
      'app-config': `${paths.appConfigs}/app/prod.js`,
  ...
  entry: path.resolve(__dirname, `../../src/entrypoints/${entry}/index`),
  target: 'web',
  output: {
    path: path.resolve(__dirname, `../../../static/${entry}`),
    publicPath: './',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      title: 'Can Explode ' + _.upperFirst(entry),
